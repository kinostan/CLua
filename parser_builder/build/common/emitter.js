...
const parser_types_1 = require("#root/common/parser-types");
class BaseEmitter {
    constructor() {
        this.code = "";
        this.indent = 0;
    ...
    emit_enum(enum_class_object) {
        ...
        (0, parser_types_1.set_field_type)(enum_class_object.get_enum_size_unit(), size_of);
...
class ParserEmitter extends BaseEmitter {
    ...
    emit_diagnostic_block(error_node_type, start_tok, end_tok) {
