...
import { LengthContext, CaptureLengthPattern, MatchContextLengthPattern, PatternSwitchParser } from "./context";
...
export {
    ...
    LengthContext, CaptureLengthPattern, MatchContextLengthPattern, PatternSwitchParser,
