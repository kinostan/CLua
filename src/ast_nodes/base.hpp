...
#include <common/clua/node_handle.hpp>
...
namespace CLuaNodes {
    ...
    class BaseErrorNode : public BaseNode {
        public:
        BaseErrorNode(CLua::TokenSpan& error_span): error_span(error_span)
        {};
        CLua::TokenSpan error_span;
    };
    ...
    class NumberNode : public BaseNode {
        public:
        NumberNode(Common::f64): value(value)
        {
