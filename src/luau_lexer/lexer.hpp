...
namespace LuaU {
    ...
    class LexerContext {
        ...
        {
            return lexer_state.consumer_mode;
        };
        ...
        inline void switch_consumer_mode(ConsumerMode new_consumer_mode)
        {
            ...
            lexer_state.consumer_mode = new_consumer_mode;
            lexer_state.luau_capture_state = LuaUCaptureState();
            lexer_state.luau_code_state = LuaUCodeState();
        };

        inline MetaConsumerMode see_current_meta_consumer_mode()
        {
            return lexer_state.meta_consumer_mode;
        };

        inline void switch_meta_consumer_mode(MetaConsumerMode new_meta_consumer_mode)
        {
            lexer_state.meta_consumer_mode = new_meta_consumer_mode;
        };
        ...
        inline LuaUCodeState& get_luau_code_state()
        {
            return lexer_state.luau_code_state;
        };

        inline LuaUCaptureState& get_luau_capture_state()
        {
            return lexer_state.luau_capture_state;
        };
